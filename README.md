...
*Discipline. Logic. Engineering.*

Structured approach to algorithms — frameworks first, problems second.

---

![Two Pointers](https://img.shields.io/badge/Two_Pointers-Done-7c3aed?style=for-the-badge&logoColor=white)
![Sliding Window](https://img.shields.io/badge/Sliding_Window-In_Progress-3b1f6e?style=for-the-badge&logoColor=white)
...
|---|---------|---------|---------|
| 11 | Container With Most Water | Left / Right | [→](./1.%20LeetCode_Frameworks/1.%20TwoPointers/Practice/3.%20left-right/11-container-with-most-water.py) |
| 26 | Remove Duplicates from Sorted Array | Fast & Slow | [→](./1.%20LeetCode_Frameworks/1.%20TwoPointers/Practice/1.%20fast-slow/26-remove-duplicated-from-sorted-array.py) |
| 88 | Merge Sorted Array | One Pointer Each | [→](./1.%20LeetCode_Frameworks/1.%20TwoPointers/Practice/2.%20one-pointer-each/88-merge-sorted-array.py) |
...
![LeetCode](https://img.shields.io/badge/LeetCode-3b1f6e?style=flat-square&logo=leetcode&logoColor=white)
